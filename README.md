...
By default, only SVs with a site quality of at least 200 (`-y 200`) are kept. You can, for instance, also just filter for PASS.

`sansa somatic -y 0 --pass --nosvt -a pon.bcf tumor.bcf`

PoN files generated by [delly](https://github.com/dellytools/delly) for the [1000 Genomes long-read data](https://www.nature.com/articles/s41586-025-09290-7) are available for [GRCh38](https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1KG_ONT_VIENNA/release/v1.0/delly-unfiltered-hg38/all.delly.hg38.1kGP.ont.bcf) and [CHM13](https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1KG_ONT_VIENNA/release/v1.0/delly-unfiltered-chm13/all.delly.t2t.1kGP.ont.bcf).
